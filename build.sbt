...
addCommandAlias(
  "winGraalBuild",
  """set graalVMNativeImageCommand := "C:\\Users\\circleci\\workdir\\graalvm\\graalvm-ce-java11-20.0.0\\bin\\native-image.cmd"; set graalVMNativeImageGraalVersion := None; set graalVMNativeImageOptions -= "-H:UseMuslC=/opt/graalvm/stage/resources/bundle/"; graalvm-native-image:packageBin"""
)
